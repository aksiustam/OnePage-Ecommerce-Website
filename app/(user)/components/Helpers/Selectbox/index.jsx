...
export default function Selectbox({ datas = [], className, action, children }) {
  ...
  return (
    <>
      {datas.length > 0 && (
        <div
          className={`my-select-box border border-qgray-border w-full h-full  ${
            className || ""
          }`}
        >
          <button
            ...
            type="button"
            className="my-select-box-btn placeholder:text-sm text-sm px-6 text-dark-gray w-full h-full font-normal bg-white focus:ring-0 focus:outline-none"
          >
