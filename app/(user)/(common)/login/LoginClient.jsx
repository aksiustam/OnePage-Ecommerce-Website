...
import forgotPass from "@/app/actions/Auth/forgotPass";
            ...
            <div className="relative w-auto my-6 mx-auto  max-w-lg">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none ">
                <div className="flex items-start justify-between p-5 border-b border-solid rounded-t">
                  <h3 className="text-xl font-semibold ">Şifremi Unuttum?</h3>
                  <button
                ...
                <div className="relative py-6 px-12 flex-auto">
                  <div className="flex flex-wrap">
                    <div className="flex flex-col items-center justify-center">
                      <div className="mb-2">
                        <p>Size E-posta ile yeni şifre gönderebiliriz...</p>
                      </div>
            ...
            <div className="lg:w-[572px] w-full h-[783px] bg-white flex flex-col justify-center sm:p-10 p-5 border border-[#E0E0E0]">
              <div className="w-full">
                <div className="title-area flex flex-col justify-center items-center relative  mb-7">
                  ...
                  <div className="w-full mt-4 text-left text-red-600">
                    {error}
                  </div>
                </div>
