            ...
            <div className="lg:w-1/2 w-full">
                ...
                <div className="xl:w-1/2 w-full  h-[196px] flex flex-col item justify-center bg-[#FFEAE5] p-5">
                  ...
                  <div className="w-full flex items-center justify-center">
                    <div className="w-full">
                      ...
                      <p className="text-[13px] text-black leading-[30px] text-center">
                        +90 544 942 42 82
                      </p>
                    </div>
                    <div className="w-full">
              ...
              <div className="p-5 flex flex-col justify-between w-full bg-[#E7F2EC]">
                ...
                <div className="w-full h-[256px] mt-5">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3149.5322405770694!2d32.56665497630765!3d37.871233906597034!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14d09b9463eaec29%3A0x784b49ad6f487584!2sMAYPLAST%C4%B0K%20ROTASYON%20BUZA%C4%9EI%20KUL%C3%9CBES%C4%B0%20SU%20DEPOSU%20DONMAZ%20SULUK%20LED%20I%C5%9EIKLI%20%C3%9CR%C3%9CNLER!5e0!3m2!1str!2str!4v1724848246619!5m2!1str!2str"
                    allowFullScreen=""
                    loading="lazy"
