...
const AdminProductClient = (props) => {
  ...
  const [quillValueDesc, setQuillValueDesc] = useState(product?.quill?.desc);
  const [quillValueSpec, setQuillValueSpec] = useState(product?.quill?.spec);
  const [quillValueKargo, setQuillValueKargo] = useState(product?.quill?.kargo);
  ...
  const {
    ...
    defaultValues: {
      name: product.name,
      desc: product.desc,
      sarjprice: product.price?.sarjprice,
      sarjinprice: product.price?.sarjinprice,
      fisprice: product.price?.fisprice,
      fisinprice: product.price?.fisinprice,
      isikprice: product.price?.isikprice,
      isikinprice: product.price?.isikinprice,
